    ...
    <div class="dropdown show-dropdown">
      ...
      <li class="header-title"> Sidebar Background</li>
            ...
            <li class="button-container text-center">
                <button id="twitter" class="btn btn-round btn-info sharrre"><i class="fab fa-twitter"></i> 路 45</button>
                <button id="facebook" class="btn btn-round btn-info sharrre"><i class="fab fa-facebook-f"></i> 路 50</button>
                <br>
                <br>
                <span></span>
            </li>
...
<script type="text/javascript" src="http://code.jquery.com/jquery-1.7.2.min.js"></script>
  ...
  <script src="<?php echo base_url() ?>/assets/js/now-ui-dashboard.min.js" type="text/javascript"></script><!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
