...
<div class="row">
    <?php
            $galeri = $this->Home_m->selectGaleri();
            foreach ($galeri as $row){                         
        ?>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img src="<?php echo base_url(); ?>admin/assets/galeri/<?php echo $row->foto; ?>" data-toggle="modal" data-target="#example" data-isi="Web Master" /> </div>
