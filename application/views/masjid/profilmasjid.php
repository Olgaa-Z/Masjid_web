...
<div class="section padding_layout_1">
  <div class="container">
    ...
    <!-- end section -->
    <div  style="text-align: justify; margin-top: 40px; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 30px; word-spacing: 10px; letter-spacing: 1px;">
