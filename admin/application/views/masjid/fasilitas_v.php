                            ...
                            <tbody>
                                ...
                                foreach ($fasilitas as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-success" href="<?php echo site_url('Masjid/editfasilitasform/' . $row->id_fasilitas); ?>"> EDIT </a>
                                            <a class="btn btn-outline-danger" href="<?php
                                            echo site_url('Masjid/deleteFasilitas/' . $row->id_fasilitas);
