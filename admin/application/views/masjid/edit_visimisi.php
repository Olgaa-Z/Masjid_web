          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="title" style="margin-left : 10px; ">EDIT DATA VISI MISI</h3>
              </div>
              <div class="card-body all-icons">
                ...
                <div class="table-responsive" style="margin-right: 40px; margin-left : 40px;"> 
                    <form method="post" action="<?php echo site_url('Masjid/editVisimisi'); ?>" 
                        enctype="multipart/form-data">

                        <input type ="hidden" name="id_masjid" value="<?php echo $row->id_masjid; ?>">


                        <label for="comment">VISI MISI</label>
                        <textarea id="summernote" name="visimisi"><?php echo $row->visimisi; ?></textarea>
