                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                foreach ($masjid as $row) {
                                    ...
                                    ?>    
                                    <tr>
                                        <td style="text-align: justify;"><?php echo word_limiter( $row->sejarah, 16); ?></td>
                                        <td>
                                            <a class="btn btn-outline-success" href="<?php echo site_url('Masjid/editlainform/' . $row->id_masjid); ?>"> EDIT </a></td>
                                        </tr>
                                    </tr>
