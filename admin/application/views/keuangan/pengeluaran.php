            ...
            <div class="card">
              <div class="card-header">
               <!--  <a class="btn btn-dark" style="margin-left : 10px; " href="<?php echo base_url('Keuangan/listpengeluaran');  ?>">
                ...
                <h5 class="title" style="margin-left : 10px; ">TAMBAH  PENGELUARAN</h5>
              </div>
              <div class="card-body all-icons">
                <div class="row">
                
                    <div class="table-responsive" style="margin-right: 40px; margin-left : 40px;"> 
                    <form method="post" action="<?php echo site_url('Keuangan/insertPengeluaran'); ?>" 
                        enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="exampleFormControlInput1">JUMLAH ANGKA PENGELUARAN</label>
                            <input type="NUMBER" name="pengeluaran" class="form-control" id="exampleFormControlInput1">
                        </div>
              ...
              <div class="card-header">
                <h5 class="title" style="margin-left : 10px; ">LIST PENGELUARAN</h5>
              </div>
              <div class="card-body all-icons">
                <div class="row">
                        ...
                        <table class="table" id="dataTable">
                            ...
                            <tbody>
                                ...
                                $omsettrans= $this->Keuangan_m->sum_total_pengeluaran_year();
                                $no = 1;
                                foreach ($uang as $row) {
                                    ?>  
                                    <tr>    
                                        ...
                                        <td>
                                            <a class="btn btn-outline-success" href="<?php echo site_url('Keuangan/editpengeluaranform/' . $row->id_keuangan); ?>"> EDIT </a>
...
<script type="text/javascript">
  var tab = "";
    $(document).ready(function () {
       ...
       $('.count_omset').html('<?php echo $this->Currency_m->rps($omsettrans->count_omset)?>');
