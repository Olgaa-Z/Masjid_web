    ...
    -->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li>
            <a href="<?php echo site_url('Jamaah/dataZakatJamaah'); ?>">
            <i class="now-ui-icons business_badge"></i>
              <p>JAMAAH (ZAKAT)</p>
            </a>
          </li>
          ...
          <li class="nav-item">
              ...
              <div class="collapse" id="keuangan">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo site_url('Keuangan/laporan'); ?>">Laporan Kas</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <!-- <li>
              <a href="<?php echo site_url('Dashboard/socmed'); ?> ">
                <i class="now-ui-icons education_paper"></i>
                  <p>MEDIA SOSIAL</p>
              </a>
            </li> -->
