                            ...
                            <tbody>
                                ...
                                foreach ($jumat as $row) {
                                    ...
                                    <tr>    
                                        ...
                                        <td>
                                        <a class="btn btn-outline-success" href="<?php echo site_url('Jadwal/editjumatform/' . $row->id); ?>"> EDIT </a>
                                        <a class="btn btn-outline-danger" href="<?php echo site_url('Jadwal/deleteJumat/'.$row->id); ?>"onclick="return confirm('Apakah anda yakin akan menghapus?')">Hapus </a>   
