                            ...
                            <tbody>
                                ...
                                foreach ($tpa as $row) {
                                    ...
                                    <tr>    
                                        ...
                                        <td>
                                        <a class="btn btn-outline-success" href="<?php echo site_url('Jadwal/edittpaform/' . $row->id); ?>"> EDIT </a>
                                        <a class="btn btn-outline-danger" href="<?php echo site_url('Jadwal/deleteTpa/'.$row->id); ?>" onclick="return confirm('Apakah anda yakin akan menghapus?')">Hapus </a>  
                                        </td>
                                    </tr>
