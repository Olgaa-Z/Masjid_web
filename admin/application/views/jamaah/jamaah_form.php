              ...
              <div class="card-body all-icons">
                ...
                <form  method="post" action="<?php echo site_url('Jamaah/insertJamaah'); ?>" 
                  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlInput1">PENERIMA ZAKAT : </label><br>
                        <label class="radio-inline"><input type='radio' name='zakat' value='Ya' /> Ya</label>
                        <label class="radio-inline"><input type='radio' name='zakat' value='Tidak' /> Tidak</label>
                    </div>
