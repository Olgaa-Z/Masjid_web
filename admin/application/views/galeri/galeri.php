                            ...
                            <tbody>
                                ...
                                foreach ($galeri as $row) {
                                    ...
                                    <tr>    
                                        ...
                                        <td>
                                            <a class="btn btn-outline-success" href="<?php echo site_url('Galeri/editgaleriform/' . $row->id_foto); ?>"> EDIT </a>
                                            <a class="btn btn-outline-danger" href="<?php echo site_url('Galeri/deleteGaleri/'.$row->id_foto); ?>" onclick="return confirm('Apakah anda yakin akan menghapus?')">Hapus </a>  
                                        </td>
                                    </tr>
